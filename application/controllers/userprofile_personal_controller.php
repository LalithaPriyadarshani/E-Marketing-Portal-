...
class userprofile_personal_controller extends CI_Controller {
	...
	public function index()
	{
		...
		$data['query1'] = $this->userprofile_db->fillUserDetails();
		$this->load->view('userprofile_personal_view',$data);
