        ...
        <br /> 
         ...
         <?php
        	...
        	echo '<div class="form-group" style="margin-left:25%">';
    			echo '<label for="inputFirst" class="col-sm-2 control-label">First Name</label>';
   					 echo '<div class="col-sm-10">';
      					echo '<input type="text" class="form-control" id="inputFirst" placeholder="First" style="width:35%" value="'.$row->FirstName.'" size"=50" READONLY/>';
						echo '<br />';
   					 echo '</div>';
 			echo '</div>'; 
            
            echo '<div class="form-group" style="margin-left:25%">';
    			echo '<label for="inputLast" class="col-sm-2 control-label">Last Name</label>';
   					 echo '<div class="col-sm-10">';
      					echo '<input type="text" class="form-control" id="inputLast" placeholder="Last" style="width:35%" value="'.$row->LastName.'" size"=50" READONLY />';
						echo '<br />';
   					 echo '</div>';
 			echo '</div>'; 
			...
			echo '<div class="form-group" style="margin-left:25%">';
    			echo '<label for="City_Showroom" class="col-sm-2 control-label">City</label>';
   					 echo '<div class="col-sm-10">';
 			...
 			echo '</div>';
  			...
  			echo '<div class="form-group" style="margin-left:10%">'; 
    			echo '<div class="col-sm-offset-2 col-sm-10">'; 
					echo '<a class=\'btn btn-primary \' onclick=\'return confirm(\'Confirm this action?\')\' href=\'http://localhost/E_Marketing_Portal/index.php/userprofile_personal_controller\'><span class="glyphicon glyphicon-pencil"></span>  Edit Profile </a>';
    			echo '</div>'; 
  			echo '</div>'; 
		echo '</form>'; 
		}
