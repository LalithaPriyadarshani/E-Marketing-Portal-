<?php include('header_bootstrap.php'); ?>
	...
	<div id="wrapper-personal-account">
	  ...
	  <?php
		...
		echo form_open('userprofile_business_controller/updateDetails');?>
        	...
        	echo '<div class="form-group" style="margin-left:25%">';
    			echo '<label for="inputCompany" class="col-sm-2 control-label">Company Name</label>';
   					 echo '<div class="col-sm-10">';
      					echo '<input type="text" class="form-control" id="CompanyName" placeholder="Company" style="width:35%" value="'.$row->CompanyName.'" size"=50" READONLY/>';
						echo '<br />';
   					 echo '</div>';
 			echo '</div>';
