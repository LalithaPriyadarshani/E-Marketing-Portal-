...
<body onload="" style="background-color:#FFF;">
		...
		<?php
    		...
    		if(isset($_SESSION['myProfile'])){
				...
				$logOutMarginTop = '12px';
				$adminControlMarginTop = '-52px';
			}
			else{
		...
		<div class="upperLine" style="margin-left:6px; ">
        	...
        	<div class="user-profile" style="visibility:<?php echo $viewMyprofile ?>; margin-left:<?php echo $margine_left ?>; margin-top:-10px; ">
            ...
            <div class="controls" style="margin-left:<?php echo $controlLeft; ?>; visibility:<?php echo $controlVisibitity; ?>; margin-top:5px;">
            |
    		...
    		<div class="regnLogContainer" style=" margin-top:8px; margin-left:<?php echo $regAndLogLeft; ?>; visibility:<?php if(isset($_SESSION['signInUp'])){ echo $_SESSION['signInUp'];}else{ echo 'visible';} ?>;">
        		<ul>
            		<li>
                    	<?php
        ...
        <div class="upArrow" style="left:1220px; top:50px;">
        	<img src="<?php echo base_url(); ?>images/upArrow.png" alt="Arrow" width="20" height="10" />
        </div><!-- /upArrow -->
		<div class="controlOptions" style="height:<?php echo $controlOptionHeight; ?>; left:1074px; top:58px;">
        	<div class="user-controls" style="visibility:<?php echo $userControlVisibility; ?>; margin-top:14px">
            	<ul>
                    ...
                    <a href="<?php echo site_url('/user_controller/myFavList/');?>">
                    <li>
